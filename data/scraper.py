...
class Scraper:
    ...
    def GetLinks(self):
        ele=self.driver.find_elements_by_css_selector("a")
        print(ele)
...
urls = [
    ...
    # "http://chooseyourstory.com/story/viewer/default.aspx?StoryId=11274",#--cannot read
...
scraper = Scraper()
tree = scraper.GoToURL("http://chooseyourstory.com/story/viewer/default.aspx?StoryId=53134")
actions = scraper.GetLinks()
scraper.GetText()
print(actions)
